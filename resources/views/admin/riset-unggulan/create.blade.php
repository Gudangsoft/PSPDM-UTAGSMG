                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror"
                                   value="{{ old('judul') }}" placeholder="Mis: Riset Modal Manusia">
                            @error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-12">
                            <label class="form-label">Deskripsi</label>
                            <textarea name="deskripsi" rows="4" class="form-control"
                                      placeholder="Deskripsi singkat tentang bidang riset ini...">{{ old('deskripsi') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card card mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4 text-center">
                        <div id="icon-preview" style="width:64px; height:64px; background:#C0304A; border-radius:14px; display:flex; align-items:center; justify-content:center; color:#fff; font-size:1.6rem; margin:0 auto 8px;">
                            <i id="preview-icon" class="bi bi-lightbulb"></i>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="icon" id="icon-input" class="form-control @error('icon') is-invalid @enderror"
                               value="{{ old('icon', 'bi-lightbulb') }}" placeholder="bi-lightbulb">
                        @error('icon')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <small class="text-muted">Cari ikon di <a href="https://icons.getbootstrap.com" target="_blank">icons.getbootstrap.com</a></small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <input type="text" id="color-text" class="form-control" value="{{ old('warna', '#C0304A') }}"
                                   placeholder="#C0304A" style="font-family:monospace;">
                        </div>
