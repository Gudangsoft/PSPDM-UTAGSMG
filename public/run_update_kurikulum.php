...
$konten = '<h4 class="mb-4 text-center" style="font-weight:700;">Struktur Kurikulum Program Doktor Manajemen</h4>
...
$affected = DB::table("halaman")->where("slug", "akademik-kurikulum")->update(["konten" => $konten, "updated_at" => now()]);
echo $affected ? "<b>Berhasil diupdate!</b>" : "<b>Tidak ada perubahan (slug tidak ditemukan)</b>";
echo "<br><a href='/admin/halaman'>Lihat di Admin</a>";
