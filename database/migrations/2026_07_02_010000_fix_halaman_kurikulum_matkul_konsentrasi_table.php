...
/**
 * The "Mata Kuliah Konsentrasi" table used rowspan to merge cells, but the
 * admin/halaman edit form uses the Summernote WYSIWYG editor, which corrupts
 * rowspan/colspan tables whenever the page is opened and saved through it.
 * This rebuilds the table without any merged cells so it can't break again.
 */
...
<div class="table-responsive mb-4">
  <table class="table table-bordered align-middle" style="border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.06);">
    ...
    <tbody style="background:white;">
      <tr>
        <td class="text-center fw-bold" style="color:#C0304A;border-bottom:none;">1</td>
        <td style="font-size:.875rem;border-bottom:none;">Manajemen Human Capital Strategis</td>
        <td style="font-size:.875rem;">Human Capital Manajemen</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
      <tr>
        <td style="border-top:none;">&nbsp;</td>
        <td style="border-top:none;">&nbsp;</td>
        <td style="font-size:.875rem;">Change Organizational and Human Resource Management</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
      <tr style="background:#fafafa;">
        <td class="text-center fw-bold" style="color:#C0304A;border-bottom:none;">2</td>
        <td style="font-size:.875rem;border-bottom:none;">Manajemen Ekosistem Pasar Inovatif</td>
        <td style="font-size:.875rem;">Digital Marketing Management</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
      <tr style="background:#fafafa;">
        <td style="border-top:none;">&nbsp;</td>
        <td style="border-top:none;">&nbsp;</td>
        <td style="font-size:.875rem;">Change Organizational and Marketing Management</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
      <tr>
        <td class="text-center fw-bold" style="color:#C0304A;border-bottom:none;">3</td>
        <td style="font-size:.875rem;border-bottom:none;">Manajemen Keuangan Etis &amp; Pengembangan Berkelanjutan</td>
        <td style="font-size:.875rem;">ESG And Impact Investment</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
      <tr>
        <td style="border-top:none;">&nbsp;</td>
        <td style="border-top:none;">&nbsp;</td>
        <td style="font-size:.875rem;">Change Organizational and Financial Management</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
      <tr style="background:#fafafa;">
        <td class="text-center fw-bold" style="color:#C0304A;border-bottom:none;">4</td>
        <td style="font-size:.875rem;border-bottom:none;">Manajemen Strategik</td>
        <td style="font-size:.875rem;">Content And Process Strategic</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
      <tr style="background:#fafafa;">
        <td style="border-top:none;">&nbsp;</td>
        <td style="border-top:none;">&nbsp;</td>
        <td style="font-size:.875rem;">Change Organizational and Strategic Management</td>
        <td class="text-center fw-bold" style="color:#C0304A;">3</td>
      </tr>
    </tbody>
  </table>
