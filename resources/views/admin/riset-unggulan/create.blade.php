...
@section('title', 'Tambah Unggulan Riset')
@section('page-title', 'Tambah Unggulan Riset')
@section('content')
...
<form action="{{ route('admin.riset-unggulan.store') }}" method="POST">
    @csrf
    <div class="row g-4">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror"
                                   value="{{ old('judul') }}" placeholder="Mis: Manajemen Human Capital Strategis">
                            @error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-12">
                            <label class="form-label">Deskripsi Singkat</label>
                            <input type="text" name="deskripsi" class="form-control"
                                   value="{{ old('deskripsi') }}" placeholder="Mis: Pengembangan SDM, kepemimpinan, dan modal psikologis">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label d-flex align-items-center gap-2">
                                <span class="badge" id="badge-{{ $key }}" style="background:#C0304A;">{{ $label }}</span>
                                {{ $label }}
                            </label>
                            <input type="text" name="topik_{{ $key }}" class="form-control"
                                   value="{{ old('topik_'.$key) }}"
                                   placeholder="Judul topik riset {{ $label }}...">
                        </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="admin-card card">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4 p-3 rounded-3" id="preview-box"
                         style="border-left:4px solid #C0304A; background:#f8fafc;">
                        <div id="preview-title" style="font-weight:700;font-size:.9rem;color:#1e293b;">Nama Konsentrasi</div>
                        <div id="preview-desc" style="font-size:.75rem;color:#6b7280;">Deskripsi singkat</div>
                        <div class="d-flex gap-1 mt-2 flex-wrap">
                            <span class="badge" id="prev-a" style="background:#C0304A;">Riset a</span>
                            <span class="badge" id="prev-b" style="background:#C0304A;">Riset b</span>
                            <span class="badge" id="prev-c" style="background:#C0304A;">Riset c</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2 align-items-center mb-2">
                            <input type="color" name="warna" id="color-input"
                                   ...
                                   value="{{ old('warna','#C0304A') }}" style="width:50px;height:38px;">
                            <input type="text" id="color-text" class="form-control"
                                   value="{{ old('warna','#C0304A') }}" placeholder="#C0304A" style="font-family:monospace;">
                        </div>
                    ...
                    <div class="form-check form-switch mb-4">
                        ...
                        <label class="form-check-label" for="is_active" style="font-weight:600;">Tampilkan di Website</label>
                    </div>
